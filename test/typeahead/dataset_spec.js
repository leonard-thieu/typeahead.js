describe('Dataset', function() {
  ...
  function syncEmptySuggestions(query, sync, async) {
    sync([]);
  }

  function syncMockSuggestions(query, sync, async) {
    sync(mockSuggestions);
  }

  function syncMockSuggestionsDisplayFn(query, sync, async) {
    sync(mockSuggestionsDisplayFn);
  }

  function asyncSync(query, sync, async) {
