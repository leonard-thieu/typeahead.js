...
(function(root, factory) {
    ...
    var Input = function() {
        ...
        _.mixin(Input.prototype, EventEmitter, {
            ...
            bind: function bind() {
                ...
                this.$input.on("blur.tt", onBlur).on("focus.tt", onFocus).on("keydown.tt", onKeydown).on("input.tt", onInput);
                return this;
            },
    ...
    var Typeahead = function() {
        ...
        function Typeahead(o, www) {
            ...
            this._hacks();
            this.menu.bind().onSync("selectableClicked", this._onSelectableClicked, this).onSync("datasetCleared", this._onDatasetCleared, this).onSync("datasetRendered", this._onDatasetRendered, this).onSync("asyncRequested", this._onAsyncRequested, this).onSync("asyncCanceled", this._onAsyncCanceled, this).onSync("asyncReceived", this._onAsyncReceived, this);
            this.input.bind().onSync("focused", this._onFocused, this).onSync("blurred", this._onBlurred, this).onSync("select", this._onSelect, this).onSync("open", this._onOpen, this).onSync("close", this._onClose, this).onSync("moveUp", this._onMoveUp, this).onSync("moveDown", this._onMoveDown, this).onSync("queryChanged", this._onQueryChanged, this).onSync("whitespaceChanged", this._onWhitespaceChanged, this).onSync("langDirChanged", this._onLangDirChanged, this);
        }
            ...
            initialize: function initialize(o, datasets) {
                ...
                function attach() {
                    ...
                    if (defaultHint || defaultMenu) {
                        ...
                        $input.wrap($wrapper).parent().prepend(o.hint !== false ? $hint : null).append(defaultMenu ? $menu : null);
                    }
